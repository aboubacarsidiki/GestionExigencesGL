...
class CollaborateurController extends Zend_Controller_Action
{
    ...
    {
        // TODO Auto-generated CollaborateurController::indexAction() default action
    }
    public function inscriptionAction ()
    {
        ...
        if ($this->getRequest()->isPost()) {
            ...
            if ($AFI->isValid($formData)) {
                ...
                $user = new Application_Model_DbTable_Collaborateur();
    ...
    public function editAction ()
    {
        ...
        if ($this->getRequest()->isPost()) {
            ...
            if ($form->isValid($formData)) {
                ...
                $users = new Application_Model_DbTable_Collaborateur();
